      ...
      <section className="aboutus">
        <div className="cntr-txt__aboutus bg-black">
          ...
          <p className="text__aboutus padding-cntr-txt__space text-2xl text-white">
            ...
            primeros pasos hasta alcanzar su máximo potencial. Donde puedan
            forjar no solo sus habilidades en el campo, sino también su carácter
        ...
        <div className="cntr-central__aboutus">
          <div className="central-cntr__aboutus">
            ...
            <p className="text__aboutus text-white text-2xl">
              {/* David Urrego, fundador de D10, es un joven de 32 años con una
              pasión por el fútbol y el desarrollo juvenil. En su experiencia
              como Futbolista y hoy Orientador de jugadores, ha guiado chicos
        ...
        <div className="cntr-txt__aboutus bg-black">
          ...
          <p className="text__aboutus padding-cntr-txt__space text-white text-2xl">
            ...
            cuales se harán como pre-venta del proyecto en el segundo semestre
            del año actual y que nos servirán como modelo de trabajo para que en
            todo 2025 cumplamos nuestro objetivo principal que es ver D10 en
            todo el país, teniendo una escala de crecimiento exponencial, donde
            podamos sumar más servicios a nuestro portafolio como campamentos,
        ...
        <div className="cntr-img__aboutus img-bg-right__aboutus">
          ...
          <div className="cntr-side__aboutus">
            ...
            <p className="text__aboutus text-white text-2xl">
              ...
              aquellos que buscan no solo ropa deportiva, sino una experiencia
              que refleje su pasión por el movimiento, la salud y el bienestar.
              <br />
              Nos esforzamos por impulsar un cambio positivo en la vida de las
              personas, promoviendo un estilo de vida activo y saludable.
              Buscamos superar las expectativas de nuestros clientes al ofrecer
              productos que no solo cumplan con los estándares más altos de
              rendimiento, durabilidad y comodidad, sino que también reflejen
              nuestra dedicación a la sostenibilidad y responsabilidad social. */}
        ...
        <div className="cntr-img__aboutus img-bg-left__aboutus">
          <div className="cntr-side__aboutus">
            ...
            <p className="text__aboutus text-white text-2xl">
              ...
              rincones de Colombia que se respire fútbol, donde todas las
              escuelas que se quieran vincular puedan hacerlo con facilidad,
              logrando así , tener la mayor cantidad de niños y niñas vistiendo
              nuestra marca pero también recibiendo un entrenamiento optimo,
              guiados por sus entrenadores ya formados en nuestra plataforma
              educativa totalmente gratis. Sumándole por consecuencia a ese buen
              trabajo aumentar las estadísticas de éxito en los procesos de
              nuestros deportistas afiliados.
              <br />
              ...
              por su innovación, calidad superior y compromiso inquebrantable
              con la excelencia. Aspiramos a ser más que una marca; buscamos
              convertirnos en un estilo de vida, inspirando a personas de todo
              el mundo a abrazar la actividad física y alcanzar sus metas a
              través de prendas deportivas de vanguardia. */}
