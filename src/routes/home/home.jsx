...
export default function Home() {
  ...
  const { sections, loading } = useContext(LoadContext);
    ...
    <>
      ...
      <section className="home">
        <div className="img-container__home">
          {sections.sectionOne.bg_photo != "" ? (
            <img
              src={sections.sectionOne.bg_photo}
        ...
        <div className="container__home">
          <h1 className="title__home text-black text-8xl select-none">
            {sections.sectionOne.company}
          </h1>
          <h1 className="title__home text-6xl select-none">
            {sections.sectionOne.slogan}
          </h1>
      ...
      <section className="about">
        {sections.sectionOne.bg_photo != "" ? (
          <img
            src={sections.sectionTwo.bg_photo}
            alt="Descripción de la imagen"
        ...
        <div className="content__about">
          <h1 className="text-4xl text-[#ffc702] select-none">
            {sections.sectionTwo.title}
          </h1>
          <p className="text__about text-2xl text-white select-none">
            {sections.sectionTwo.description}
          </p>
          <Link
            to={"/about-us"}
      ...
      <section className="commercial">
        {sections.sectionThree.video != "" ? (
          <video
            src={sections.sectionThree.video}
      ...
      {/* <!-- Collection Section --> */}
      <CarouselCollections collections={sections.sectionFour.collection} />
      ...
      <section className="news__banner bg-black">
        <div className="container__news__banner">
          ...
          <h2 className="subtitle__news__banner text-2xl text-white select-none">
            {sections.sectionFour.news.title}
          </h2>
          <p className="text__news__banner text-lg text-[#999999] select-none">
            {sections.sectionFour.news.description}
          </p>
          <Link
            to={sections.sectionFour.news.link}
      ...
      <section className="academy">
        ...
        >
          ...
          <div className="top-0 left-0 right-0 bottom-0 z-10 absolute">
            {sections.sectionFive.bg_photo != "" ? (
              <img
                className="relative object-cover w-full h-full"
                src={sections.sectionFive.bg_photo}
              />
            ) : (
              <Loading />
            )}
          ...
          <div className="w-full h-full grid place-content-center justify-center z-30">
            ...
            <div className="select-none absolute top-1/3 mt-5 left-1/3  transform -translate-y-1/2 flex flex-col z-20 items-center justify-center">
              <h1 className="text-9xl font-black text-[#FFC702] mb-4 select-none">
                {sections.sectionFive.title_1}
              </h1>
            </div>
      ...
      <section className="sponsors bg-black">
        <h1 className="title__sponsors text-4xl text-white select-none">
          {sections.sectionSix.tile}
        </h1>
        <div className="container__sponsors">
          <CarouselSponsors sponsors={sections.sectionSix.icons} />
        </div>
      </section>
